        ...
        <div class="col-xl-10">
          ...
          <h3 class="hero-title">DANH NGHIỆP CÓ NHU CẦU VỀ CHUYỂN ĐỔI SỐ VUI LÒNG:</h3>
            <div class="btn-group justify-content-center">
              <a href="{{ env('APP_URL') }}goi-yeu-cau" class="th-btn">Gởi yêu cầu Chuyển đổi số</a>
      ...
      <div class="cta-area space bg-theme text-center" data-bg-src="{{ env('APP_URL') }}assets/frontend/img/bg/cta_shape_2.png">
        <div class="row justify-content-center">
          <div class="col-lg-10">
            ...
            <div class="btn-group justify-content-center">
              <a href="{{ env('APP_URL') }}" class="th-btn style3">Gởi yêu cầu chuyển đổi số</a>
              <a href="{{ env('APP_URL') }}" class="th-btn style6">Tư vấn chuyển đổi số</a>
            </div>
          </div>
        </div>
      </div>
