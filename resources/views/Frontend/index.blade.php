        ...
        <div class="col-xl-10">
          ...
          <h3 class="hero-title">DOANH NGHIỆP CÓ NHU CẦU VỀ CHUYỂN ĐỔI SỐ VUI LÒNG:</h3>
            <div class="btn-group justify-content-center">
              <a href="{{ env('APP_URL') }}goi-yeu-cau" class="th-btn">Gởi nhu cầu Chuyển đổi số</a>
              <a href="{{ env('APP_URL') }}tu-van-chuyen-doi-so" class="th-btn style5">Tư vấn Chuyển đổi số</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="slider-area text-center">
        <div class="swiper th-slider brand-slider1" id="brandSlider1" data-slider-options='{"breakpoints":{"0":{"slidesPerView":2},"576":{"slidesPerView":"2"},"768":{"slidesPerView":"3"},"992":{"slidesPerView":"4"},"1200":{"slidesPerView":"5"},"1400":{"slidesPerView":"6"}}}'>
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <a href="https://dx.gov.vn/" class="brand-box" target="_blank">
                <img src="{{ env('APP_URL') }}assets/frontend/img/brand/link5.png" alt="" style="height:50px;">
              </a>
            </div>
            @endfor
          </div>
      ...
      <div class="cta-area space bg-theme text-center" data-bg-src="{{ env('APP_URL') }}assets/frontend/img/bg/cta_shape_2.png">
        <div class="row justify-content-center">
          <div class="col-lg-10">
            ...
            <div class="btn-group justify-content-center">
              <a href="{{ env('APP_URL') }}goi-yeu-cau" class="th-btn style3">Gởi nhu cầu chuyển đổi số</a>
              <a href="{{ env('APP_URL') }}tu-van-chuyen-doi-so" class="th-btn style6">Tư vấn chuyển đổi số</a>
            </div>
          </div>
        </div>
      </div>
