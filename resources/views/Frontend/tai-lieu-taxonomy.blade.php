...
<div class="page-title page-blog">
    <div class="container">
      <div class="title-wrapper">
        <div data-top="transform: translateY(0px);opacity:1;" data--120-top="transform: translateY(-30px);opacity:0;" data-anchor-target=".page-title" class="title">{{ $tax['ten'] }}</div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="blog-item item swin-transition">
                                ...
                                <div class="block-content">
                                    <h5 class="title"><a href="{{ env('APP_URL') }}tai-lieu/{{ $ds['slug'] }}">{{ $ds['ten'] }}</a></h5>
                                </div>
                            </div>
                        </div>
                        @endforeach
        ...
        <div class="row">
            <div class="col-12">
                <div class="swin-btn-wrap center">
                    <a href="{{ env('APP_URL') }}chi-tiet-tai-lieu/{{ $tl['slug'] }}" class="swin-btn center form-submit btn-transparent" style="font-size:30px;width:90%;color:#d10700;background: #ffff00;line-height:35px;"> <span>	{{ $tl['ten'] }} </span></a>
                </div>
            </div>
        </div>
        <hr />
