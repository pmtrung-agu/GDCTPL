...
<div class="wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        <div class="card-box">
          <h3 class="m-t-0"><a href="{{ env('APP_URL') }}admin/user" class="btn btn-primary"><i class="mdi mdi-reply-all"></i></a> {{ __('Thêm tài khoản người dùng') }}</h3>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" id="ghi_chu" name="ghi_chu" class="form-control" placeholder="Ghi chú mô tả chuyên gia" value="{{ old('ghi_chu')}}">
                            </div>
                        </div>
                    </div>
                  </div>
