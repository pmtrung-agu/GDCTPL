...
@section('title', 'Thêm mới Danh mục Văn bản')
@section('body')
<div class="wrapper">
    <div class="container-fluid">
        <div class="card-box">
            <div class="box-header">
                <h3><a href="{{ env('APP_URL') }}admin/danh-muc/van-ban" class="btn btn-primary"><i class="fa fa-reply-all"></i></a> Danh mục Văn bản</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ env('APP_URL') }}admin/danh-muc/van-ban/create" method="POST" class="form-horizontal" role="form">
                            {{ csrf_field() }}
