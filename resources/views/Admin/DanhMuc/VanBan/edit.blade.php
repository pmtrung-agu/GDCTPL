...
@section('title', 'Chỉnh sửa Dnah mục Văn bản')
@section('css')
            ...
            <div class="col-12">
                <div class="card-box">
                    <div class="box-header">
                        <h3><a href="{{ env('APP_URL') }}admin/danh-muc/van-ban" class="btn btn-primary"><i class="fa fa-reply-all"></i></a> Chỉnh Danh mục Văn bản </h3>
                    </div>
                    <div class="box-body">
                        <form action="{{ env('APP_URL') }}admin/danh-muc/van-ban/update" method="POST" class="form-horizontal" role="form">
                            {{ csrf_field() }}
