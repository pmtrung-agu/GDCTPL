    ...
    <div class="container-fluid">
        <div class="card-box">
            <div class="box-header">
                <h3><a href="{{ env('APP_URL') }}admin/danh-muc/tai-lieu" class="btn btn-primary"><i class="fa fa-reply-all"></i></a> Danh mục Tài liệu</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ env('APP_URL') }}admin/danh-muc/tai-lieu/create" method="POST" class="form-horizontal" id="dinhkemform" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    ...
                                    @foreach($danhmuc as $dm)
                                        <option value="{{ $dm['_id'] }}" @if($id_parent==$dm['_id']) selected @endif>{{ $dm['ten'] }}</option>
                                    @endforeach
                                </select>
                                </div>
                            </div>
