    ...
    <div class="container-fluid">
        <div class="card-box">
            <div class="box-header">
                <h3><a href="{{ env('APP_URL') }}admin/danh-muc/nganh-nghe" class="btn btn-primary"><i class="fa fa-reply-all"></i></a> Thông tin Ngành nghề</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ env('APP_URL') }}admin/danh-muc/nganh-nghe/create" method="POST" class="form-horizontal" role="form">
                            {{ csrf_field() }}
                                ...
                                <div class="col-10">
                                    <select name="id_dm_linh_vuc" id="id_dm_linh_vuc" class="form-control select2" data-placeholder="Chọn Lĩnh vực">
                                        ...
                                        @foreach($dm_linh_vuc as $lv)
                                            <option value="{{ $lv['_id'] }}" @if($lv['_id'] == old('id_dm_linh_vuc')) selected @endif>{{ $lv['ten'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
