            ...
            <div class="col-12">
                <div class="card-box">
                    <div class="box-header">
                        <h3><a href="{{ env('APP_URL') }}admin/danh-muc/thong-tin" class="btn btn-primary"><i class="fa fa-reply-all"></i></a> Chỉnh sửa Danh mục Thông tin </h3>
                    </div>
                    <div class="box-body">
                        <form action="{{ env('APP_URL') }}admin/danh-muc/thong-tin/update" method="POST" class="form-horizontal" role="form">
                            {{ csrf_field() }}
