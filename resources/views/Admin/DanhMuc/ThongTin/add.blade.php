    ...
    <div class="container-fluid">
        <div class="card-box">
            <div class="box-header">
                <h3><a href="{{ env('APP_URL') }}admin/danh-muc/thong-tin" class="btn btn-primary"><i class="fa fa-reply-all"></i></a> Danh mục Thông tin</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-12">
                        <form action="{{ env('APP_URL') }}admin/danh-muc/thong-tin/create" method="POST" class="form-horizontal" role="form">
                            {{ csrf_field() }}
