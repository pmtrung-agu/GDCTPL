...
@section('title', __('Sửa Tin tức Sự kiện'))
@section('css')
...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h3 class="m-t-0"><a href="{{ env('APP_URl') }}admin/thong-tin" class="btn btn-primary btn-sm"><i class="mdi mdi-reply-all"></i> {{ __('Trở về') }}</a> {{ __('Sửa Tin tức Sự kiện') }}</h3>
                    <form action="{{ env('APP_URL') }}admin/thong-tin/update" method="post" id="dinhkemform" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-actions">
                            <a href="{{ env('APP_URL') }}admin/thong-tin" class="btn btn-light"><i class="fa fa-reply-all"></i> {{ __('Trở về') }}</a>
