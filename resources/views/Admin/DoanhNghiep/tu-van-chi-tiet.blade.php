...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><a href="{{ env('APP_URL') }}admin/doanh-nghiep/tu-van-chuyen-doi-so" class="btn btn-sm btn-primary"><i class="fa fa-reply-all"></i></a> Nội dung Tư vấn Chuyển đổi số Doanh nghiệp</h4>
                    <div>
                ...
                <div class="card-box">
                    ...
                    <form action="{{ env('APP_URL') }}admin/doanh-nghiep/tu-van-chuyen-doi-so/chi-tiet/update" method="post" id="dinhkemform" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-actions">
                            <a href="{{ env('APP_URL') }}admin/doanh-nghiep/tu-van-chuyen-doi-so" class="btn btn-light"><i class="fa fa-reply-all"></i> {{ __('Trở về') }}</a>
