...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h4 class="header-title mb-4"><a href="{{ env('APP_URL') }}admin/doanh-nghiep/nhu-cau-chuyen-doi-so" class="btn btn-sm btn-primary"><i class="fa fa-reply-all"></i></a> Nội dung Nhu cầu Chuyển đổi số Doanh nghiệp [{{ $ds['nhu_cau'] }}]</h4>
                    <div>
                ...
                <div class="card-box">
                    ...
                    <form action="{{ env('APP_URL') }}admin/doanh-nghiep/nhu-cau-chuyen-doi-so/chi-tiet/update" method="post" id="dinhkemform" enctype="multipart/form-data">
                        {{ csrf_field() }}
