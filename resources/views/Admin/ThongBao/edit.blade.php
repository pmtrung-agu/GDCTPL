...
@section('title', __('SửaThông báo của HHDN'))
@section('css')
...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h3 class="m-t-0"><a href="{{ env('APP_URl') }}admin/hiep-hoi-doanh-nghiep/thong-bao" class="btn btn-primary btn-sm"><i class="mdi mdi-reply-all"></i> {{ __('Trở về') }}</a> {{ __('SửaThông báo HHDN') }}</h3>
                    <form action="{{ env('APP_URL') }}admin/hiep-hoi-doanh-nghiep/thong-bao/update" method="post" id="dinhkemform" enctype="multipart/form-data">
                        {{ csrf_field() }}
