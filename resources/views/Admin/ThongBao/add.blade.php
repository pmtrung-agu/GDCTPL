...
@section('title', __('Thêm mới Thông báo của HHDN'))
@section('css')
...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h3 class="m-t-0"><a href="{{ env('APP_URl') }}admin/hiep-hoi-doanh-nghiep/thong-bao" class="btn btn-primary btn-sm"><i class="mdi mdi-reply-all"></i> {{ __('Trở về') }}</a> {{ __('Thêm mới Thông báo HHDN') }}</h3>
                    <form action="{{ env('APP_URL') }}admin/hiep-hoi-doanh-nghiep/thong-bao/create" method="post" id="dinhkemform" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-body">
                            <hr />
                            @if($errors->any())
                            ...
                            @endif
                            @php
                            $noi_dung = old('tieu_de'); $tieu_de = old('tieu_de');
                            @endphp
                            <div class="form-group row">
                                <label class="control-label col-md-2 text-right p-t-10">{{ __('Tiêu đế') }}</label>
                                <div class="col-12 col-md-10">
                                    <input type="text" name="tieu_de" id="tieu_de" class="form-control" value="{{ $tieu_de }}" placeholder="Tiêu đề" required>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="form-actions">
                            <a href="{{ env('APP_URL') }}admin/hiep-hoi-doanh-nghiep/thong-bao" class="btn btn-light"><i class="fa fa-reply-all"></i> {{ __('Trở về') }}</a>
