            ...
            <div class="col-12">
                <div class="card-box">
                    <div class="box-header">
                        <h3><a href="<?php echo e(env('APP_URL')); ?>admin/danh-muc/tai-lieu" class="btn btn-primary"><i class="fa fa-reply-all"></i></a> Chỉnh Danh mục Tài liệu </h3>
                    </div>
                    <div class="box-body">
                        <form action="<?php echo e(env('APP_URL')); ?>admin/danh-muc/tai-lieu/update" method="POST" class="form-horizontal"  id="dinhkemform" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

                            <input type="hidden" name="id" value="<?php echo e($ds['_id']); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input type="slug" name="slug" class="form-control" id="slug" value="<?php echo e($ds['slug']); ?>" placeholder="SLUG" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    ...
                                    <?php $__currentLoopData = $danhmuc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($dm['_id']); ?>" <?php if($ds['id_parent']==$dm['_id']): ?> selected <?php endif; ?>><?php echo e($dm['ten']); ?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-2">
                                    <input type="text" name="ghi_chu" id="ghi_chu" value="<?php echo e($ds['ghi_chu']); ?>" class="form-control" placeholder="Ghi chú">
                                </div>
                                <label class="col-2 col-form-label">Thứ tự</label>
                                <div class="col-4">
                                    <input type="number" name="thu_tu" id="thu_tu" value="<?php echo e($ds['thu_tu']); ?>" class="form-control" placeholder="Thứ tự">
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\GDCTPL\resources\views/Admin/DanhMuc/TaiLieu/edit.blade.php ENDPATH**/ ?>