...
<script type="text/javascript">
        ...
        var chart6_options = {
            series: [{
                name: 'Mức độc CĐS',
                data: <?php echo json_encode($chart6_data); ?>,
            }],
                chart: {
                type: 'bar',
                height: 350
        ...
        xaxis: {
            categories: <?php echo json_encode($chart6_label, JSON_UNESCAPED_UNICODE ); ?>,         
            title: {
...
<?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/KhaoSatCDS/bieu-do-6.blade.php ENDPATH**/ ?>