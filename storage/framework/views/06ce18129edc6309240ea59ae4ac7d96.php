...
<?php $__env->startSection('title'); ?> <?php echo e(__('Thêm tài khoản người dùng')); ?> <?php $__env->stopSection(); ?>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" id="ghi_chu" name="ghi_chu" class="form-control" placeholder="Ghi chú mô tả chuyên gia" value="<?php echo e(old('ghi_chu')); ?>">
                            </div>
                        </div>
                    </div>
                  </div>
...
<?php $__env->startSection('js'); ?>
  ...
  <script type="text/javascript">
       $(document).ready(function() {
          ...
          $("#roles").select2({
            placeholder: "<?php echo e(__('Chọn quyền')); ?>"
          });
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/User/add.blade.php ENDPATH**/ ?>