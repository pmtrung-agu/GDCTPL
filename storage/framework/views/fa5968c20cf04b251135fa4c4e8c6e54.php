...
<div class="row">
	<div class="col-12">
    	<div class="card-box table-responsive">
    		...
    		<form action="<?php echo e(env('APP_URL')); ?>admin/san-pham/update" method="post" id="dinhkemform" enctype="multipart/form-data">
                      ...
                      <div class="col-md-10">
                          <select name="id_product_category[]" multiple="multiple" id="id_product_category" class="form-control select2" required data-placeholder="Chọn loại sản phẩm">
                            ...
                            <?php $__currentLoopData = $product_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($cat['_id']); ?>" <?php if(in_array($cat['_id'], $product['id_product_category'])): ?> selected <?php endif; ?>><?php echo e($cat['ten']); ?></option>
                              <?php if($cat['level_1']): ?>
                                <?php $__currentLoopData = $cat['level_1']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($l1['_id']); ?>" <?php if(in_array($l1['_id'], $product['id_product_category'])): ?> selected <?php endif; ?>>---| <?php echo e($l1['ten']); ?></option>
                                    <?php if($l1['level_2']): ?>
                                      <?php $__currentLoopData = $l1['level_2']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($l2['_id']); ?>" <?php if(in_array($l2['_id'], $product['id_product_category'])): ?> selected <?php endif; ?>>---|---| <?php echo e($l2['ten']); ?></option>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              <?php endif; ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                      <label class="btn btn-info">
                          ...
                          <i class="fa fa-file-photo-o"></i> Chọn hình Sản phẩm
                      </label>
                    </div>
                    ...
                    <div class="col-md-6">
                      <select name="id_seller" id="id_seller" class="form-control select2">
                        <?php if($sellers): ?>
                          ...
                          ?>
                            <option value="<?php echo e($seller['_id']); ?>" <?php if($seller['_id']==$product['id_seller']): ?> selected <?php endif; ?>><?php echo e($seller['username']); ?> <?php if($dn): ?> - <?php echo e($dn['ten']); ?> <?php endif; ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                      </select>
                    </div>
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/SanPham/edit.blade.php ENDPATH**/ ?>