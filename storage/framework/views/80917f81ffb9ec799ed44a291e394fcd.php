...
<div class="row">
	<div class="col-12">
    	<div class="card-box table-responsive">
    		<h3 class="m-t-0"><a href="<?php echo e(env('APP_URL')); ?>admin/san-pham" class="btn btn-info"><i class="mdi mdi-reply-all"></i></a> Thêm sản phẩm</h3>
    		<form action="<?php echo e(env('APP_URL')); ?>admin/san-pham/create" method="post" id="dinhkemform" enctype="multipart/form-data">
              ...
              <div class="col-md-12">
                  <div class="form-group row">
                      ...
                      <div class="col-md-4 input-group">
                        ...
                        <input type="text" id="code" name="code" class="form-control" placeholder="Mã sản phẩm" value="<?php echo e(old('code')); ?>" required />
                      </div>
                  </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                  <div class="form-group row">
                      ...
                      <div class="col-md-10">
                          <input type="text" id="title" name="title" class="form-control" placeholder="Tên sản phẩm" value="<?php echo e(old('title')); ?>" required />
                      </div>
                  </div>
              </div>
            </div>
                          ...
                          <select name="id_product_category[]" multiple="multiple" id="id_product_category" class="form-control select2" required data-placeholder="Chọn loại sản phẩm">
                            ...
                            <?php if($product_categories): ?>
                              <?php $__currentLoopData = $product_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat['_id']); ?>"><?php echo e($cat['ten']); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                          </select>
                      </div>
            ...
            <div class="row">
              <div class="col-md-12">
                  <div class="form-group row">
                      ...
                      <div class="col-md-10">
                        <textarea name="description" id="description" required placeholder="Mô tả sản phẩm" class="form-control"><?php echo e(old('description')); ?></textarea>
                      </div>
                  </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                      <textarea name="contents" id="contents" placeholder="Mô tả chi tiết" class="form-control summernote"><?php echo e(old('contents')); ?></textarea>
                    </div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                      <input type="text" id="prices" name="prices" class="form-control number" placeholder="Giá" value="<?php echo e(old('prices') !== null ? old('prices') : 0); ?>" required />
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                      <label class="btn btn-info">
                          ...
                          <i class="fa fa-file-photo-o"></i> Chọn hình ảnh Sản phẩm
                      </label>
                    </div>
                    ...
                    <div class="col-md-6">
                      <select name="id_seller" id="id_seller" class="form-control select2">
                        <?php if($sellers): ?>
                          ...
                          <?php
                            $dn = App\Models\DoanhNghiep::find($seller['id_doanh_nghiep'])
                          ?>
                            <option value="<?php echo e($seller['_id']); ?>" <?php if($seller['_id'] == $id_user): ?> selected <?php endif; ?>><?php echo e($seller['username']); ?> <?php if($dn): ?> - <?php echo e($dn['ten']); ?> <?php endif; ?></option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                      </select>
                    </div>
...
<?php $__env->startSection('js'); ?>
  ...
  <script src="<?php echo e(env('APP_URL')); ?>assets/backend/libs/summernote/summernote-lite.js"></script>
  ...
  <script src="<?php echo e(env('APP_URL')); ?>assets/backend/js/script.js" type="text/javascript"></script>
    ...
    $(document).ready(function() {
      ...
      $("#title").keyup(function(){
        var _this = $(this);
        $.get('<?php echo e(env('APP_URL')); ?>slug/'+$("#code").val()+ " " + $("#title").val(), function(data){
          $("#slug").val(data);
        });
      });
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/SanPham/add.blade.php ENDPATH**/ ?>