        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    ...
                    <form action="<?php echo e(env('APP_URL')); ?>admin/doanh-nghiep/create" method="post" id="dinhkemform" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" id="ngay_thanh_lap" name="ngay_thanh_lap" class="form-control" value="<?php echo e($ngay_thanh_lap); ?>" data-toggle="input-mask" data-mask-format="00/00/0000" placeholder="__/__/____" />
                                </div>
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/DoanhNghiep/add.blade.php ENDPATH**/ ?>