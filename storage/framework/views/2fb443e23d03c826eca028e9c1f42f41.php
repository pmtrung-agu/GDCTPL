...
<script type="text/javascript">
    var chart7_options = {
          ...
          data: <?php echo json_encode($chart7_data); ?>,
        }],
          chart: {
          height: 350,
          type: 'radar',
        ...
        xaxis: {
          categories: <?php echo json_encode($chart7_label, JSON_UNESCAPED_UNICODE ); ?>
...
</script><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/KhaoSatCDS/bieu-do-7.blade.php ENDPATH**/ ?>