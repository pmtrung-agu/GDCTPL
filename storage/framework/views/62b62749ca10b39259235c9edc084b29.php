...
<script type="text/javascript">
        //Chart bar
        var chart2_options = {
            series: <?php echo json_encode($chart2_data); ?>,
            chart: {
                width: 530,
                type: 'pie',
            },
            labels: <?php echo json_encode($chart2_label, JSON_UNESCAPED_UNICODE ); ?>,
            responsive: [{
                breakpoint: 480,
                options: {
                    chart: {
...
</script><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/KhaoSatCDS/bieu-do-2.blade.php ENDPATH**/ ?>