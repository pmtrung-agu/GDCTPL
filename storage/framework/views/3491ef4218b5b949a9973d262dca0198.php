...
<?php $__env->startSection('title', 'Thêm mới danh mục Đơn vị'); ?>
    ...
    <div class="container-fluid">
        <div class="card-box">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-12">
                        <form action="<?php echo e(env('APP_URL')); ?>admin/danh-muc/don-vi/create" method="POST" class="form-horizontal" role="form">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" id="dien_thoai" name="dien_thoai" class="form-control" placeholder="Điện thoại" value="<?php echo e(old('dien_thoai')); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        <label class="control-label col-md-2 text-right p-t-10">Địa chỉ</label>
                                        <div class="col-md-10">
                                            <input type="text" id="address_4" name="address[]" class="form-control" placeholder="Số nhà, tên đường, khóm, ấp,..." value="<?php echo e(old('address.3')); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/DanhMuc/DonVi/add.blade.php ENDPATH**/ ?>