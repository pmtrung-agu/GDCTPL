...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $__env->yieldContent('title'); ?> | <?php echo e(__("GIÁO DỤC CHÍNH TRỊ - PHÁP LUẬT")); ?> - <?php echo e(__("AGU")); ?></title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="<?php echo e(__("GIÁO DỤC CHÍNH TRỊ - PHÁP LUẬT")); ?> - <?php echo e(__("AGU")); ?>" name="description" />
                ...
                <div class="container-fluid">
                    ...
                    <div class="logo-box">
                        <a href="<?php echo e(env('APP_URL')); ?>admin" class="logo text-center">
                            <span class="logo-lg">
                                <img src="<?php echo e(env('APP_URL')); ?>assets/backend/images/logo.png" title="<?php echo e(__("GIÁO DỤC CHÍNH TRỊ - PHÁP LUẬT")); ?>" height="60">
                            </span>
                            <span class="logo-sm">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 text-center">
                        &copy; 2025 <?php echo e(__('GIÁO DỤC CHÍNH TRỊ - PHÁP LUẬT')); ?>
...
</html><?php /**PATH E:\Lara_Projects\GDCTPL\resources\views/Admin/layout.blade.php ENDPATH**/ ?>