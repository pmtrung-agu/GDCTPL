...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h3 class="m-t-0"><a href="<?php echo e(env('APP_URl')); ?>admin/tai-lieu" class="btn btn-primary btn-sm"><i class="mdi mdi-reply-all"></i> <?php echo e(__('Trở về')); ?></a> <?php echo e(__('Sửa Tài liệu Chuyển đổi số')); ?></h3>
                    <form action="<?php echo e(env('APP_URL')); ?>admin/tai-lieu/update" method="post" id="dinhkemform" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="control-label col-md-1 text-right p-t-10"><?php echo e(__(key: 'Ngày tạo')); ?></label>
                                <div class="col-md-2">
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/TaiLieu/edit.blade.php ENDPATH**/ ?>