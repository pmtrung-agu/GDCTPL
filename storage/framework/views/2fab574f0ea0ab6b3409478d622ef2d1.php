...
<div class="row">
	<div class="col-12">
    	<div class="card-box table-responsive">
    		<h3 class="m-t-0"><a href="<?php echo e(env('APP_URL')); ?>admin/hiep-hoi-doanh-nghiep/hoi-phi" class="btn btn-info"><i class="mdi mdi-reply-all"></i></a> Chỉnh sửa Thông tin Hội phí Doanh nghiệp</h3>
    		<form action="<?php echo e(env('APP_URL')); ?>admin/hiep-hoi-doanh-nghiep/hoi-phi/update" method="post" id="dinhkemform" enctype="multipart/form-data">
          ...
          <div class="form-body">
                      ...
                      <div class="col-md-4 input-group">
                        ...
                        <select name="nam" id="nam" class="form-control" required>
                            <?php for($i=$year-5; $i<=$year+5; $i++): ?>
                                <option value="<?php echo e($i); ?>" <?php if($ds['nam'] == $i): ?> selected <?php endif; ?>><?php echo e($i); ?></option>
                            <?php endfor; ?>
                        </select>
                      </div>
                  </div>
                          ...
                          <select name="id_doanh_nghiep" id="id_doanh_nghiep" class="form-control select2" required data-placeholder="Chọn Doanh nghiệp">
                            ...
                            <?php if($doanhnghiep): ?>
                              <?php $__currentLoopData = $doanhnghiep; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($dn['_id']); ?>" <?php if($dn['_id'] == $ds['id_doanh_nghiep']): ?> selected <?php endif; ?> ><?php echo e($dn['ten']); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                          </select>
                      </div>
            ...
            <div class="row">
                <div class="col-md-12">
                  <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="so_tien" name="so_tien" class="form-control number" placeholder="Số tiền" value="<?php echo e($ds['so_tien']); ?>" required />
                        </div>
                        <label class="control-label col-md-1 text-right p-t-10"><?php echo e(__('Ngay thu')); ?></label>
                        <div class="col-md-2">
                            <input type="text" id="ngay_thu" name="ngay_thu" class="form-control" placeholder="Ngày thu" value="<?php echo e($ds['ngay_thu']); ?>" required />
                        </div>
                  </div>
                </div>
              </div>
            <div class="row">
              <div class="col-md-12">
                  <div class="form-group row">
                      ...
                      <div class="col-md-10">
                        <textarea name="noi_dung" id="noi_dung" required placeholder="Nội dung thu" class="form-control"><?php echo e($ds['noi_dung']); ?></textarea>
                      </div>
                  </div>
              </div>
            </div>
            ...
            <div id="list_hinhanh" class="form-group row portfolioContainer">
              <?php if($ds['photos']): ?>
                <?php $__currentLoopData = $ds['photos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="col-sm-6 col-md-4 items draggable-element text-center">
                    <input type="hidden" name="hinhanh_aliasname[]" value="<?php echo e($p['aliasname']); ?>" readonly/>
                    <input type="hidden" name="hinhanh_filename[]" value="<?php echo e($p['title']); ?>" class="form-control"/>
                    <a href="<?php echo e(env('APP_URL')); ?>storage/images/origin/<?php echo e($p['aliasname']); ?>" class="image-popup">
                      <div class="portfolio-masonry-box">
                        <div class="portfolio-masonry-img">
                          <img src="/storage/images/thumb_360x200/<?php echo e($p['aliasname']); ?>" class="thumb-img img-fluid" alt="work-thumbnail">
                        </div>
                    ...
                    <a href="<?php echo e(env('APP_URL')); ?>image/delete/<?php echo e($p['aliasname']); ?>" onclick="return false;" class="btn btn-danger btn-sm delete_file" style="position:absolute;top:40px;right:30px;">
                      <i class="fa fa-trash"></i>
                    </a>
                    <input type="text" name="hinhanh_title[]" value="<?php echo e($p['title']); ?>" class="form-control"/>
                  </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              <?php endif; ?>
            </div>
          ...
          <div class="form-actions">
              <a href="<?php echo e(env('APP_URL')); ?>admin/hiep-hoi-doanh-nghiep/hoi-phi" class="btn btn-light"><i class="fa fa-reply-all"></i> Trở về</a>
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/HoiPhi/edit.blade.php ENDPATH**/ ?>