...
<script type="text/javascript">
        //Chart bar
        var chart5_options = {
            series: <?php echo json_encode($chart5_data); ?>,
            chart: {
                width: 530,
                type: 'pie',
            },
            labels: <?php echo json_encode($chart5_label, JSON_UNESCAPED_UNICODE ); ?>,
            responsive: [{
                breakpoint: 480,
                options: {
                    chart: {
...
</script><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/KhaoSatCDS/bieu-do-5.blade.php ENDPATH**/ ?>