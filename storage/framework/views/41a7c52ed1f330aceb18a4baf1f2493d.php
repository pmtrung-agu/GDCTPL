        ...
        <div class="row">
            <div class="col-12">
                <div class="swin-btn-wrap center">
                    <a href="<?php echo e(env('APP_URL')); ?>chi-tiet-tai-lieu/<?php echo e($tl['slug']); ?>" class="swin-btn center form-submit btn-transparent" style="font-size:30px;width:90%;color:#d10700;background: #ffff00;"> <span>	<?php echo e($tl['ten']); ?> </span></a>
                </div>
            </div>
        </div>
        <hr />
...
<?php echo $__env->make('Frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\GDCTPL\resources\views/Frontend/tai-lieu-taxonomy.blade.php ENDPATH**/ ?>