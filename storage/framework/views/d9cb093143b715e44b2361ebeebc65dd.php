...
<?php $__env->startSection('title', 'Phân tích Dữ liệu khảo sát theo Lĩnh vực'); ?>
...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">   
                    <h3><i class="far fa-address-card text-primary"></i> Phân tích dữ liệu khảo sát theo Lĩnh vực: <?php echo e($so_luong); ?> </h3>
                    <form action="<?php echo e(env('APP_URL')); ?>admin/khao-sat-muc-do-cds/theo-linh-vuc" method="GET" id="ThongKeForm">
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="card-box">   
                    ...
                    <h4>Biểu đồ Mức độ sẵn sàng chuyển đổi số trên 6 khía cạnh của <?php echo e($lv); ?></h4>
                    <table class="table table-border table-striped">
                        ...
                        <tbody>
                            ...
                            <?php
                                $count_lv= App\Models\CDSKhaoSat::where(3,'=', $lvv['_id'][3])->count();
                                $danhsach_lv = App\Models\CDSKhaoSat::where(3,'=',$lvv['_id'][3])->get();
                                $sum[$b3[3]] = 0;
                                foreach($danhsach_lv as $dsh) {
                                    $sum[$b3[3]] += intval($dsh[$b3[3]]);
                                }
                                if($count_lv > 0) $tl = $sum[$b3[3]]/$count_lv;
                                else $tl = 0;
                                $sum[$lvv['_id'][3]] += $tl;
            ...
            <div class="col-12 col-md-6">
                <div class="card-box">
                    ...
                    <h4 class="text-center">Mức độ sẵn sàng chuyển đổi số trên 6 khía cạnh của <?php echo e($lv); ?></h4>
                ...
                <div class="card-box">   
                    ...
                    <table class="table table-border table-striped">
                        ...
                        <tbody>
                            ...
                            <?php
                                $dn_b1 = App\Models\CDSKhaoSat::where(3,'=',$lv)->first();
                                $bar_label[] = $b1[0] .'. ' . $b1[1];
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/KhaoSatCDS/linh-vuc.blade.php ENDPATH**/ ?>