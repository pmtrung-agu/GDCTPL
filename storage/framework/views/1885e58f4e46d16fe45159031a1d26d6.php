<?php $__env->startSection('title', __('Tài liệu Chuyển đổi số')); ?>
        ...
        <div class="row">
            <div class="col-12 card-box">
                ...
                <table class="table table-border table-bordered table-striped table-sm">
                    ...
                    <?php $__currentLoopData = $danhsach; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $ds): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <?php else: ?>
                                    <img src="<?php echo e(env('APP_URL')); ?>assets/backend/images/logo_sm.png" title="<?php echo e($ds['ho_ten']); ?>" alt="<?php echo e($ds['ho_ten']); ?>" style="height:30px;">
                                <?php endif; ?>
                            </td>
                            <td>
                                <a href="<?php echo e(env('APP_URL')); ?>tai-lieu-chi-tiet/<?php echo e($ds['slug']); ?>" target="_blank"><strong><?php echo e($ds['ten']); ?></strong></a>
                            ...
                            <td>
                                <?php if(isset($ds['tags']) && $ds['tags']): ?>
                                    <?php $__currentLoopData = $ds['tags']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <?php if($tg): ?>
                                            <span class="badge badge-success"><i class="fa fa-tag"></i> <?php echo e($tg['ten']); ?></span>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
                                <a href="<?php echo e(env('APP_URL')); ?>admin/tai-lieu/delete/<?php echo e($ds['_id']); ?>" onclick="return confirm('Chắc chắc xóa?')"><i class="fas fa-trash text-danger"></i></a>&nbsp;
                                <a href="<?php echo e(env('APP_URL')); ?>admin/tai-lieu/edit/<?php echo e($ds['_id']); ?>"><i class="fas fa-pencil-alt"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                    ...
                    <?php if($keywords): ?>
                        <?php echo e($danhsach->withPath(env('APP_URL').'admin/tai-lieu?' . $_SERVER['QUERY_STRING'])); ?>

                    <?php else: ?>
                        <?php echo e($danhsach->withPath(env('APP_URL') . 'admin/tai-lieu')); ?>
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/GDCTPL/resources/views/Admin/TaiLieu/list.blade.php ENDPATH**/ ?>