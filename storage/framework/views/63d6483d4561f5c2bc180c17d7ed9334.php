...
<script type="text/javascript">
    ...
    var chart1_options = {
        series: [{
            data: <?php echo json_encode($chart1_data); ?>
        ...
        xaxis: {
            categories: <?php echo json_encode($chart1_label, JSON_UNESCAPED_UNICODE ); ?>,
        },
        yaxis: [{
            labels: {
                show: false
...
</script><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/KhaoSatCDS/bieu-do-1.blade.php ENDPATH**/ ?>