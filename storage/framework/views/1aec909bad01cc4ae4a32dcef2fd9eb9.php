...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo e(__("GIÁO DỤC CHÍNH TRỊ - PHÁP LUẬT")); ?></title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="<?php echo e(__("GIÁO DỤC CHÍNH TRỊ - PHÁP LUẬT")); ?>" name="description" />
    ...
    <body class="account-pages">
        ...
        <div class="wrapper-page account-page-full">
            ...
            <div class="text-center">
                <p class="account-copyright">© 2025 <?php echo __("GIÁO DỤC CHÍNH TRỊ - PHÁP LUẬT"); ?></p>
            </div>
        </div>
        <!-- Vendor js -->
...
<?php /**PATH E:\Lara_Projects\GDCTPL\resources\views/Admin/login.blade.php ENDPATH**/ ?>