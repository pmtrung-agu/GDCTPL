...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h3><a href="<?php echo e(env('APP_URL')); ?>admin/doanh-nghiep/nhu-cau-chuyen-doi-so/add" class="btn btn-primary"><i class="fa fa-plus"></i> Thêm mới </a> Nhu cầu Chuyển đổi số</h3>
                    <?php if($danhsach): ?>
                    <table class="table table-border table-hovered table-striped table-bodered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo e($ds['nhu_cau']); ?></td>
                                <td><a href="<?php echo e(env('APP_URL')); ?>admin/doanh-nghiep/nhu-cau-chuyen-doi-so/chi-tiet/<?php echo e($ds['_id']); ?>"><?php echo $ds['noi_dung'][0]['noi_dung']; ?></a></td>
                                <td class="text-center" style="vertical-align: middle;">
                                    <?php if(App\Http\Controllers\UserController::is_roles('Admin,Manager,ABA')): ?>
                                    <a href="<?php echo e(env('APP_URL')); ?>admin/doanh-nghiep/nhu-cau-chuyen-doi-so/tinh-trang/<?php echo e($ds['_id']); ?>" class="tinh-trang">
