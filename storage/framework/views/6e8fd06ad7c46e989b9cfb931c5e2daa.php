    ...
    <div class="container-fluid">
        <div class="card-box">
            <div class="box-header">
                <h3><a href="<?php echo e(env('APP_URL')); ?>admin/danh-muc/thong-tin" class="btn btn-primary"><i class="fa fa-reply-all"></i></a> Danh mục Thông tin</h3>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="col-12">
                        <form action="<?php echo e(env('APP_URL')); ?>admin/danh-muc/thong-tin/create" method="POST" class="form-horizontal" role="form">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/DanhMuc/ThongTin/add.blade.php ENDPATH**/ ?>