...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h3 class="m-t-0"><a href="<?php echo e(env('APP_URl')); ?>admin/thong-tin" class="btn btn-primary btn-sm"><i class="mdi mdi-reply-all"></i> <?php echo e(__('Trở về')); ?></a> <?php echo e(__('Thêm mới Thông tin')); ?></h3>
                    <form action="<?php echo e(env('APP_URL')); ?>admin/thong-tin/create" method="post" id="dinhkemform" enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="control-label col-md-1 text-right p-t-10"><?php echo e(__('Thứ tự')); ?></label>
                                <div class="col-md-1">
                        ...
                        <div class="form-actions">
                            <a href="<?php echo e(env('APP_URL')); ?>admin/thong-tin" class="btn btn-light"><i class="fa fa-reply-all"></i> <?php echo e(__('Trở về')); ?></a>
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/ThongTin/add.blade.php ENDPATH**/ ?>