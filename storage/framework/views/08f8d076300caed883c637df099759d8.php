...
<script type="text/javascript">
    ...
    var chart8_options = {
        series: [{
            data: <?php echo json_encode($chart8_data); ?>
        ...
        xaxis: {
            categories: <?php echo json_encode($chart8_label, JSON_UNESCAPED_UNICODE ); ?>,
        },
        yaxis: [{
            labels: {
                show: false
...
</script><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/KhaoSatCDS/bieu-do-8.blade.php ENDPATH**/ ?>