        ...
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="box-body">
                        <form action="<?php echo e(env('APP_URL')); ?>admin/danh-muc/tai-lieu/update" method="POST" class="form-horizontal" role="form">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/DanhMuc/TaiLieu/edit.blade.php ENDPATH**/ ?>