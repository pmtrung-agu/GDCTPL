        ...
        <div class="col-xxl-4 col-lg-4 col-md-4">
          <div class="th-blog blog-single has-post-thumbnail">
            ...
            <div class="blog-content">
              ...
              <p class="blog-text" alt="<?php echo e($tt['mo_ta']); ?>" title="<?php echo e($tt['mo_ta']); ?>" style="height: 100px;overflow:hidden;"><?php echo e(Str::limit($tt['mo_ta'],140)); ?></p>
            </div>
          </div>
        </div>
...
<?php echo $__env->make('Frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Frontend/thong-tin.blade.php ENDPATH**/ ?>