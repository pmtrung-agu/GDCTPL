                        ...
                        <div class="card-box p-5">
                            <h2 class="text-uppercase text-center pb-4">
                                <a href="<?php echo e(env('APP_URL')); ?>" class="text-success">
                                    <span><img src="<?php echo e(env('APP_URL')); ?>/assets/backend/images/logo.png" alt="" height="26"></span>
                                </a>
                            </h2>
...
<?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/page_not_permis.blade.php ENDPATH**/ ?>