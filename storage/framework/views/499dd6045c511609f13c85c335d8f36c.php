...
<?php $__env->startSection('title', 'Chỉnh sửa Dnah mục Văn bản'); ?>
            ...
            <div class="col-12">
                <div class="card-box">
                    <div class="box-header">
                        <h3><a href="<?php echo e(env('APP_URL')); ?>admin/danh-muc/van-ban" class="btn btn-primary"><i class="fa fa-reply-all"></i></a> Chỉnh Danh mục Văn bản </h3>
                    </div>
                    <div class="box-body">
                        <form action="<?php echo e(env('APP_URL')); ?>admin/danh-muc/van-ban/update" method="POST" class="form-horizontal" role="form">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/DanhMuc/VanBan/edit.blade.php ENDPATH**/ ?>