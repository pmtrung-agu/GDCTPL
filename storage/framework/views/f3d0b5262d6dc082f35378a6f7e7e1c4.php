<?php $__env->startSection('title', __('Thêm mới Tài liệu Chuyển đổ số')); ?>
...
<div class="wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card-box">
                    <h3 class="m-t-0"><a href="<?php echo e(env('APP_URl')); ?>admin/tai-lieu" class="btn btn-primary btn-sm"><i class="mdi mdi-reply-all"></i> <?php echo e(__('Trở về')); ?></a> <?php echo e(__('Thêm mới Tài liệu Giáo dục Chính trị - Pháp luật')); ?></h3>
                    <form action="<?php echo e(env('APP_URL')); ?>admin/tai-lieu/create" method="post" id="dinhkemform" enctype="multipart/form-data">
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\GDCTPL\resources\views/Admin/TaiLieu/add.blade.php ENDPATH**/ ?>