...
<script type="text/javascript">
        //Chart bar
        var chart11_options = {
            series: <?php echo json_encode($chart11_data); ?>,
            chart: {
                width: 500,
                type: 'pie',
            },
            labels: <?php echo json_encode($chart11_label, JSON_UNESCAPED_UNICODE ); ?>,
            dataLabels: {
...
</script><?php /**PATH E:\Lara_Projects\ABAPortal\resources\views/Admin/KhaoSatCDS/bieu-do-11.blade.php ENDPATH**/ ?>